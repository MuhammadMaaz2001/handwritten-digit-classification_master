...
NET = Net()
NET.load_state_dict(torch.load('E:/5th Semester/SWE-314 Artifical Intelligence/Project/handwritten-digit-recognition-master/model/model.pth'))
NET.eval()
